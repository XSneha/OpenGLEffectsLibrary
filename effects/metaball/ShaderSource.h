...
"    (\n"
"        /*                      (---- center ----)      (--- amplitude --)      (--- frequency ---)      (----- phase -----) (size)*/\n"
"        sphere_descriptor(  vec3(0.50, 0.50, 0.50), vec3(0.20, 0.25, 0.25), vec3( 10.0, 5.0, 5.0), vec3( 30.0, 45.0, 90.0),  0.100),\n"
"        sphere_descriptor(  vec3(0.50, 0.50, 0.50), vec3(0.25, 0.20, 0.25), vec3( 5.0, 10.0, 5.0), vec3( 45.0, 90.0,120.0),  0.250),\n"
"        sphere_descriptor(  vec3(0.50, 0.50, 0.50), vec3(0.25, 0.25, 0.20), vec3( 5.0, 5.0, 5.0), vec3( 90.0,120.0,150.0),  0.250)\n"
"    );\n"
"\n"
...
"    FragColor = vec4(ambient_lighting + diffuse_reflection + specular_reflection, 1.0)*vec4(1.0,1.0,1.0,1.0);\n"
"}\n";
